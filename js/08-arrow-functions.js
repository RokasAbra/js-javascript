...
// ARROW(rodykline) funkcija
// jei parametru bloke () yra tik 1 parametras, tai galime nerasyti () ir return
// kvadratu a * a; a **2(pakelta kvadratu) 
...
const pirmaRaid = t => t[0];
console.log(pirmaRaid(tekstas));